                    ...
                    <div class="col-lg-4">
                        <div class="right-card-details">
                            <div class="inner-right-card-details">
                                ...
                                <form action="{{ route('booking.checkout') }}" method="post">
                                    <input type="hidden" name="slug" value="{{ $park->slug }}">
                                    @csrf
                                    <div class="pt-4 px-4" style="max-width: 400px; margin: auto;">
                                        <!-- Date Picker Input -->
                                        <div class="position-relative">
                                            <input type="text" class="form-control form-control-lg"
                                                name="booking_date" id="datepicker" placeholder="Select a date">
                                            <i
                                                class="bi bi-calendar-date-fill position-absolute end-0 top-50 translate-middle-y me-3 text-muted"></i>
                                        </div>

                                        <div class="counter-box bg-white pt-4">
                                            <!-- Ticket Counters -->
                                            @foreach ($park->ticketPrices as $ticketType)
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <div>
                                                        <h6 class="mb-1 fw-semibold text-dark">
                                                            {{ $ticketType->ticketType->name }}</h6>
                                                        <small class="text-muted">
                                                            ₹{{ number_format($ticketType->price, 2) }}
                                                            <del>₹{{ number_format($ticketType->mrp, 2) }}</del>
                                                            <b class="text-lowercase">per
                                                                {{ $ticketType->ticketType->name }}</b>
                                                        </small>
                                                    </div>
                                                    <div class="d-flex align-items-center">
                                                        <input type="hidden" name="ticket_types[]"
                                                            value="{{ $ticketType->ticketType->id }}">
                                                        <button type="button" class="btn py-1 fw-bold fs-5"
                                                            data-decrease>-</button>
                                                        <input type="text"
                                                            class="form-control mx-2 text-center fw-semibold"
                                                            name="quantity[]" data-value
                                                            data-price="{{ $ticketType->price }}"
                                                            data-mrp="{{ $ticketType->mrp }}" value="1"
                                            ...
                                            <h2 class="text-success fw-bold">
                                                ₹ <label id="totalPrice">00.00</label>
                                                <span class="text-muted fs-6 ms-2">
                                                    ₹<del id="totalmrp">00.00</del>
                                                </span>
                                            </h2>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-inn">
                                        <div class="buynow">
                                            @if (Auth::check() && Auth::user()->hasRole('Customer'))
                                                <button type="submit" class="btn text-light">Checkout</button>
                                                {{-- <a href="{{ route('funbook.checkout') }}">Checkout</a> --}}
                                            @else
                                                <button type="button" class="btn text-light" data-bs-toggle="modal"
                                                    data-bs-target="#signinsocilamedia">
                                                    Checkout </button>
                                            @endif
                                        </div>
                                        <div class="form-check">
                                            <input type="checkbox" name="accept" id="accept"
                                                class="form-check-input" title="Are you sure you want to checkout?"
                                                required>
                                            <label for="accept" class="form-check-label text-xs">
                                                Are you sure you want to checkout the ticket?
                                            </label>
                                        </div>
                                ...
                                <div class="card-inn">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4">
                                            <div class="value-card">
                                                <p>Value</p>
                                                <h6 id="totalValue">₹330.00</h6>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4">
                                            <div class="value-card">
                                                <p>Discount</p>
                                                <h6 id="totalDiscount">50%</h6>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4">
                                            <div class="value-card">
                                                <p>You Save</p>
                                                <h6 id="totalSave">₹165.00</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-inn bg-white p-4 rounded shadow-sm text-center">
                                    <div class="limited-time mb-3">
                                        <span class="text-danger fw-bold text-uppercase">⏳ Time Left - Limited
                                            Offer!</span>
                                    </div>
                                    <div class="row">
                                        <div class="col-3">
                                            <div class="time-box bg-light rounded py-2">
                                                <h4 class="text-dark fw-bold mb-1">146</h4>
                                                <span class="text-muted">Day</span>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="time-box bg-light rounded py-2">
                                                <h4 class="text-dark fw-bold mb-1">12</h4>
                                                <span class="text-muted">Hr</span>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="time-box bg-light rounded py-2">
                                                <h4 class="text-dark fw-bold mb-1">45</h4>
                                                <span class="text-muted">Min</span>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="time-box bg-light rounded py-2">
                                                <h4 class="text-dark fw-bold mb-1">20</h4>
                        ...
                        <div class="right-card-details">
                            <div class="inshort">
                                ...
                                <div class="map-left">
                                    <iframe
                                        src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7324.461399853194!2d85.310152!3d23.37987!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f4e1ff1c55bacd%3A0xbd730f5ae2453d28!2sTripledots%20Software%20Services%20Pvt.%20Ltd.!5e0!3m2!1sen!2sin!4v1718364285898!5m2!1sen!2sin" " height="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                           </div>
                        </div>
                     </div>
                     {{-- <div class="right-card-details">
